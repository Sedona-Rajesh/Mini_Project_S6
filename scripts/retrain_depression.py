#!/usr/bin/env python3
"""
scripts/retrain_depression.py
──────────────────────────────
Force a complete rebuild of the Depression model.
...
logger = logging.getLogger("retrain_depression")
TASK = "depression"


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Retrain Depression model from scratch")
